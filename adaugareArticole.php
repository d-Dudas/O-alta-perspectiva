...
<form id="articol_nou" method="POST" action="./includes/adaugare_articol.inc.php">
    <label for="titlu"> Titlu:
        <br><br><input type="text" name="titlu" id = "titlu">
    </label><br><br>
    <label for="image"> Imagine:
        <br><br><input type="file" name="image" id="image">
    </label><br><br>
    <label for="text"> Articol:
        <br><br><textarea name="text" id="text"></textarea>
    </label><br><br>
    <input type="submit" value="Trimite" id="buton_submit">
</form>
